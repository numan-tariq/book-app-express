...
router.patch('/:id', isAuthenticated, isAuthorized({ hasRole: [USER_TYPES.ADMIN] }), controller.updateGenre);
router.delete('/:id', isAuthenticated, isAuthorized({ hasRole: [USER_TYPES.ADMIN] }), controller.deleteGenre);
